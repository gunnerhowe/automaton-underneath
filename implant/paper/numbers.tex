...
\newcommand{\imLmwBasePpl}{3.08}
\newcommand{\imLmwBehFreezeFiftyEnd}{1.0}
\newcommand{\imLmwBehFreezeTenEnd}{1.0}
\newcommand{\imLmwBehFreezeZeroEnd}{0.0}
\newcommand{\imLmwBehNoneFiftyEnd}{1.0}
\newcommand{\imLmwBehNoneTenEnd}{1.0}
\newcommand{\imLmwBehNoneZeroEnd}{0.52}
\newcommand{\imLmwDriftFloorPct}{10.7}
\newcommand{\imLmwHeadOne}{0.3}
\newcommand{\imLmwHeadSix}{431.9}
\newcommand{\imLmwIntFreezeFiftyEnd}{0.762}
\newcommand{\imLmwIntFreezeTenEnd}{0.45}
\newcommand{\imLmwIntFreezeZeroEnd}{0.0}
\newcommand{\imLmwIntNoneFiftyEnd}{0.45}
\newcommand{\imLmwIntNoneTenEnd}{1.0}
\newcommand{\imLmwIntNoneZeroEnd}{1.0}
\newcommand{\imLmwPplPctFreezeFifty}{21.2}
\newcommand{\imLmwPplPctFreezeTen}{13.2}
\newcommand{\imLmwPplPctFreezeZero}{11.0}
\newcommand{\imLmwPplPctNoneFifty}{20.6}
\newcommand{\imLmwPplPctNoneTen}{12.6}
\newcommand{\imLmwPplPctNoneZero}{10.7}
\newcommand{\imLmwResidMedian}{0.87}
\newcommand{\imLmwResidMin}{0.717}
\newcommand{\imLmwResurrectFreezeFifty}{1.0}
\newcommand{\imLmwResurrectFreezeTen}{1.0}
\newcommand{\imLmwResurrectFreezeZero}{0.0}
\newcommand{\imLmwResurrectNoneFifty}{1.0}
\newcommand{\imLmwResurrectNoneTen}{1.0}
\newcommand{\imLmwResurrectNoneZero}{1.0}
\newcommand{\imLmwSteps}{3000}
\newcommand{\imLmwWallLogTen}{14}
\newcommand{\imLmwWidenDepth}{64}
\newcommand{\imLmwWidenImplantPct}{-0.098}
\newcommand{\imLmwWidenInertPct}{-0.13}
